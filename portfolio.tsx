  ...
  const projects = [
    {
      ...
      description:
        "Full-stack e-commerce solution built with Laravel and Vue.js featuring payment integration, inventory management, and admin dashboard with real-time analytics.",
      tech: ["Laravel", "Vue.js", "MySQL", "Stripe API", "Redis"],
    ...
    },
    {
      title: "CRM Dashboard",
      description:
        "Customer relationship management system with Filament admin panel, featuring lead tracking, analytics, automated workflows, and team collaboration tools.",
      tech: ["Laravel", "Filament", "PostgreSQL", "Chart.js", "WebSockets"],
      image: "/placeholder.svg?height=300&width=500",
      github: "#",
      live: "#",
      featured: true,
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 max-w-7xl">
          <div className="flex h-14 sm:h-16 items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              <a href="#about" className="text-sm font-medium hover:text-primary transition-colors duration-200">
                About
              </a>
              <a href="#skills" className="text-sm font-medium hover:text-primary transition-colors duration-200">
                Skills
              </a>
              <a href="#projects" className="text-sm font-medium hover:text-primary transition-colors duration-200">
                Projects
              </a>
              <a href="#experience" className="text-sm font-medium hover:text-primary transition-colors duration-200">
                Experience
              </a>
              <a href="#contact" className="text-sm font-medium hover:text-primary transition-colors duration-200">
                Contact
              </a>
            </div>
      ...
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 px-3 sm:px-4 md:px-6 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative max-w-7xl">
          <div className="max-w-5xl mx-auto">
            <Avatar className="w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-40 lg:h-40 mx-auto mb-6 sm:mb-8 ring-2 sm:ring-4 ring-primary/20 ring-offset-2 sm:ring-offset-4 ring-offset-background dark:ring-offset-background">
              <AvatarImage src="/placeholder-user.jpg" alt="John Developer" />
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 order-1 lg:order-2">
              ...
              <Card className="text-center hover:shadow-lg transition-all duration-300 border-primary/20 hover:border-primary/40 dark:hover:shadow-primary/5">
                <CardContent className="p-4 sm:p-6">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-1 sm:mb-2">5+</div>
              ...
              <Card className="text-center hover:shadow-lg transition-all duration-300 border-primary/20 hover:border-primary/40 dark:hover:shadow-primary/5">
                <CardContent className="p-4 sm:p-6">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-1 sm:mb-2">30+</div>
